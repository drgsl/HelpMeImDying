...
public class FPS : MonoBehaviour {
    ...
    void Awake() {
        ...
        newtrans = newtrans = gameObject.transform.position;
    }
    ...
    void Update()
    {
        ...
        if (gameObject.transform.position != newtrans)
        {
            CharAnim.SetBool("isRunning", true);
            newtrans = gameObject.transform.position;
        }
        else
        {
